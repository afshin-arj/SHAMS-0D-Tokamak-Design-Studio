# HTS Compact Tokamak — Clean 0-D Point Design Studio (UI)
## Navigation

The UI keeps the primary workflows in a small set of tabs (Point Designer, Systems Mode, Scan Lab, Pareto Lab, Compare).
