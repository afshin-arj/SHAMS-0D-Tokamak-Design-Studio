...
| 3 Community default | **In progress** | 3.1 migration guide **DONE** 2026-07-17; 3.2 Zenodo/CITATION/paper pitch **DONE** 2026-07-17; 3.3 champion cases **DONE** 2026-07-17; next Studio default entry (3.4) |
...
14. **Next (Phase 3.4):** Studio as default entry — NiceGUI/Streamlit verdict-first UX for systems studies (`/ui-specialist`, `/nicegui-specialist`, `/shams-qa-explorer`)
