...
| 3 Community default | **In progress** | 3.1 migration guide **DONE** 2026-07-17; 3.2 Zenodo/CITATION/paper pitch **DONE** 2026-07-17; next champion cases (3.3) |
...
13. **Next (Phase 3.3):** Champion cases — reproducible SHAMS-only feasibility studies (reference designs with atlas + reviewer-pack evidence) that labs can cite as templates (`/fusion-performance`, `/shams-feature-development`)
