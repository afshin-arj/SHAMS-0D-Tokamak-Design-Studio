...
try:
    from .registry import CalibrationRegistry, default_registry  # type: ignore
except Exception:
    # Back-compat if `<repo>/src` is on sys.path
    from calibration.registry import CalibrationRegistry, default_registry  # type: ignore
