...
OVERLAY_LABELS: Dict[str, Tuple[str, Optional[str], str]] = {
    ...
    "include_magnet_sc_system_authority_v410": (
        "Magnet SC system / TF/PF/CS SC",
        None,
        "Per-family TF/PF/CS superconducting and engineering margins beyond magnet technology margins (proxy).",
    ),
    "include_machine_build_authority_v412": (
        "Machine build closure / Radial machine-build",
        None,
...
OVERLAY_NUMERIC_TITLES: Dict[str, str] = {
    ...
    "include_magnet_sc_system_authority_v410": "Magnet SC system / TF/PF/CS SC",
